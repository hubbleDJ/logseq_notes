...
- ### Стандартные функции
  ...
  isinstance(var, type_var) # Проверить, что переменная определенного типа
  isinstance(var, (type_1, type_2)) # Проверить, что переменная определенного типа(2 варианта)
